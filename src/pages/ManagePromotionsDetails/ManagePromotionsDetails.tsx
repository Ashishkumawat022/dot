                      ...
                      <Form.Label>
                        ...
                        {["top"].map((placement) => (
                          <OverlayTrigger
                            key={placement}
                            overlay={
                              <Tooltip id={`tooltip-${placement}`}>Start Date</Tooltip>
                            }
                          >
                            <span
                              className={`${cy.tooltips} ms-2`}
                      ...
                      <Form.Label>
                        ...
                        {["top"].map((placement) => (
                          <OverlayTrigger
                            key={placement}
                            overlay={
                              <Tooltip id={`tooltip-${placement}`}>End Date</Tooltip>
                            }
                          >
                            <span
                              className={`${cy.tooltips} ms-2`}
                      ...
                      <Form.Label>
                        ...
                        {["top"].map((placement) => (
                          <OverlayTrigger
                            key={placement}
                            overlay={
                              <Tooltip id={`tooltip-${placement}`}> Start Time</Tooltip>
                            }
                          >
                            <span
                              className={`${cy.tooltips} ms-2`}
                      ...
                      <Form.Label>
                        ...
                        {["top"].map((placement) => (
                          <OverlayTrigger
                            key={placement}
                            overlay={
                              <Tooltip id={`tooltip-${placement}`}>  End Time</Tooltip>
                            }
                          >
                            <span
                              className={`${cy.tooltips} ms-2`}
                      ...
                      <Form.Label>
                        ...
                        {["top"].map((placement) => (
                          <OverlayTrigger
                            key={placement}
                            overlay={
                              <Tooltip id={`tooltip-${placement}`}>Applyes On Days</Tooltip>
                            }
                          >
                            <span
                              className={`${cy.tooltips} ms-2`}
                      ...
                      <Form.Label>
                        ...
                        {["top"].map((placement) => (
                          <OverlayTrigger
                            key={placement}
                            overlay={
                              <Tooltip id={`tooltip-${placement}`}>Applyes On orders Types</Tooltip>
                            }
                          >
                            <span
                      ...
                      <Form.Label>
                        ...
                        {["top"].map((placement) => (
                          <OverlayTrigger
                            key={placement}
                            overlay={
                              <Tooltip id={`tooltip-${placement}`}>Priority
                              </Tooltip>
                            }
                          >
                            <span
                      ...
                      <Form.Label>
                        ...
                        {["top"].map((placement) => (
                          <OverlayTrigger
                            key={placement}
                            overlay={
                              <Tooltip id={`tooltip-${placement}`}>Promotion Type</Tooltip>
                            }
                          >
                            <span
                              className={`${cx.tooltips} ms-2`}
                      ...
                      <Form.Label>
                        ...
                        {["top"].map((placement) => (
                          <OverlayTrigger
                            key={placement}
                            overlay={
                              <Tooltip id={`tooltip-${placement}`}> Discount Type</Tooltip>
                            }
                          >
                            <span
                              className={`${cx.tooltips} ms-2`}
                      ...
                      <Form.Label>
                        ...
                        {["top"].map((placement) => (
                          <OverlayTrigger
                            key={placement}
                            overlay={
                              <Tooltip id={`tooltip-${placement}`}> Discount Amount(%)</Tooltip>
                            }
                          >
                            <span
                              className={`${cx.tooltips} ms-2`}
                      ...
                      <Form.Label>
                        ...
                        {["top"].map((placement) => (
                          <OverlayTrigger
                            key={placement}
                            overlay={
                              <Tooltip id={`tooltip-${placement}`}>  Maximum Discount Value (SAR)</Tooltip>
                            }
                          >
                            <span
                              className={`${cx.tooltips} ms-2`}
                      ...
                      <Form.Label>
                        ...
                        {["top"].map((placement) => (
                          <OverlayTrigger
                            key={placement}
                            overlay={
                              <Tooltip id={`tooltip-${placement}`}> Products</Tooltip>
                            }
                          >
                            <span
                              className={`${cx.tooltips} ms-2`}
