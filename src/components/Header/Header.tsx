    ...
    <>
      <header className={`${cx.mainHeader}`}>
        <Row className={`${cx.mobileHeader}`}>
          ...
          <Col md={4} lg={6} xl={7} className={`col-3 ${cx.infoheaderRight}`}>
            <ul>
              <li className={`${cx.help}`}>
                <Dropdown>
                  ...
                  <Dropdown.Menu className={`${cx.infodropdowns}`}>
                        <div className={`${cx.infoheading}`}>
                          Changelog
                          <img
                            src={exporticon}
                            alt="export"
                        ...
                        <Dropdown.Item href="#/action-1">
                          <div>
                            <div>
                              <div className={`${cx.infotagslist}`}>

                                <div className="d-flex ">
                                  <div className={`${cx.infotags}`}>
                                    New Feature
                                  </div>
                                  <div className={`${cx.infotagssecond}`}>
                                    Console
                                  </div>
                                </div>

                                <div className={`${cx.infotagdatessec}`}>
                                  <div>a month Ago</div>
                                  <div>
                                    <img
                                      src={calendericon}
                            ...
                            <div className={`${cx.infodetailssec}`}>
                              <div>
                                <h4>Automatic Branches Assignment</h4>
                              </div>

                              <div className={`${cx.infodetailpara}`}>
                                <p>
                                  Account owners can now assign newly created 
                                  branches automatically to specific modules in
                                 the  console, this configuration is added to
                                  branch...
                                </p>
                              </div>
              ...
              <li className={`${cx.profileBox}`}>
                <Dropdown>
                  ...
                  <Dropdown.Menu style={{backgroundColor:"#76ACFD"}}>
          ...
          >
            <Row className="align-items-center">
              ...
              <Col
                ...
                lg={5}
                xl={5}
                className={`col-3 ${cx.infoheaderRight}`}
              >
                <ul>
                  <li className={`${cx.help}`}>
                    <Dropdown>
