...
const Modals = (props: any) => {
 ...
 ######################## ORDER MODALS ########################### */}
                ...
                <Form.Group className={`${cx.formField}`}>
                  {inventoryItems ?
                    ...
                    {['top'].map((placement) => (
                      ...
                      <NavLink className={`${cx.rightLabel}`} to="#" onClick={() => { setinventoryItems(true) }}>Select by Products?</NavLink>
                    </Form.Label>
                  }
...

      {
        ...
        <Modal  className={`${cx.ctsModal}`} show={props.show} onHide={props.handleClose}>
          <Modal.Header closeButton>
            <Modal.Title>Edit Combos</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Row>
      ...
      {
        props.modalName === 'Edit Gift Card Products' &&
        <Modal  className={`${cx.ctsModal}`} show={props.show} onHide={props.handleClose}>
          <Modal.Header closeButton>
            <Modal.Title>Edit Gift Card Products</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Row>
      ...
      {
        props.modalName === 'Add Subgroups' &&
        <Modal  className={`${cx.ctsModal}`} show={props.show} onHide={props.handleClose}>
          <Modal.Header closeButton>
            <Modal.Title>Add Subgroups</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Row>
