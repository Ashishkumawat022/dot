                  ...
                  <Form.Label>
                    ...
                    {["top"].map((placement) => (
                      <OverlayTrigger
                        key={placement}
                        overlay={
                          <Tooltip id={`tooltip-${placement}`}>Roles</Tooltip>
                        }
                      >
                        <span
                          className={`${cx.tooltips} ms-2`}
...
{props.modalName === "Edit Branches" && (
        ...
        >
          ...
          <Modal.Body>
            <Row>
              <Col md={12} lg={12}>
                <Form.Group className={`${cx.formField}`}>
                  <Form.Label className={`${cx.checkboxlabel}`}>
                    <input type="radio" name="a" className={`${cx.radioinput}`} />{" "}
          ...
          <Form.Group className={`${cx.formField}`}>
            ...
            {inventoryItems ?
              <Form.Label  className={`d-block${cx.checkboxlabel}`}>
                          <input type="radio" name="a" className={`${cx.radioinput}`} />
                Branch
