                  ...
                  <Form.Label>
                    ...
                    {["top"].map((placement) => (
                      <OverlayTrigger
                        key={placement}
                        overlay={
                          <Tooltip id={`tooltip-${placement}`}>  Code</Tooltip>
                        }
                      >
                        <span
                          className={`${cx.tooltips} ms-2`}
                  ...
                  <Form.Label>
                    ...
                    {["top"].map((placement) => (
                      <OverlayTrigger
                        key={placement}
                        overlay={
                          <Tooltip id={`tooltip-${placement}`}>Discount</Tooltip>
                        }
                      >
                        <span
                          className={`${cx.tooltips} ms-2`}
                  ...
                  <Form.Label>
                    ...
                    {["top"].map((placement) => (
                      <OverlayTrigger
                        key={placement}
                        overlay={
                          <Tooltip id={`tooltip-${placement}`}>Maximum Uses</Tooltip>
                        }
                      >
                        <span
                          className={`${cx.tooltips} ms-2`}
                  ...
                  <Form.Label>
                    ...
                    {["top"].map((placement) => (
                      <OverlayTrigger
                        key={placement}
                        overlay={
                          <Tooltip id={`tooltip-${placement}`}>Applies On Days</Tooltip>
                        }
                      >
                        <span
                          className={`${cx.tooltips} ms-2`}
                  ...
                  <Form.Label>
                    ...
                    {["top"].map((placement) => (
                      <OverlayTrigger
                        key={placement}
                        overlay={
                          <Tooltip id={`tooltip-${placement}`}>Maxium Uses</Tooltip>
                        }
                      >
                        <span
                          className={`${cx.tooltips} ms-2`}
