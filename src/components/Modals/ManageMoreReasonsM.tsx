...
{props.modalName === "Quantity Adjustment Reason" && (
        <Modal
          scrollable
          className={`${cx.ctsModal}`}
          show={props.show}
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>Quantity Adjustment Reason </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Row>
              <Col md={12} lg={12}>
...
{props.modalName === "Drawer Operation Reason" && (
        <Modal
          scrollable
          className={`${cx.ctsModal}`}
          show={props.show}
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>Drawer Operation Reason </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Row>
              <Col md={12} lg={12}>
