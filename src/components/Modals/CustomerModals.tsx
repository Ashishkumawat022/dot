...
const Modals = (props: any) => {
 ...
 ######################## CUSTOMER MODALS ########################### */}
        ...
        >
          ...
          <Modal.Body>
            <Row>
              ...
              <Col md={12} lg={12}>
                <Form.Group className={`${cx.formField}`}>
                  <Form.Label>Has Orders</Form.Label>
              ...
              <Col md={12} lg={12}>
                <Form.Group className={`${cx.formField}`}>
                  <Form.Label>Blacklisted * </Form.Label>
              ...
              <Col md={12} lg={12}>
                <Form.Group className={`${cx.formField}`}>
                  <Form.Label>Loyalty Enabled *</Form.Label>
              ...
              <Col md={12} lg={12}>
                <Form.Group className={`${cx.formField}`}>
                  <Form.Label>House Account Enabled </Form.Label>
                  <FilterDropdown options={choosefilter} />
                </Form.Group>
              </Col>
      ...
      {props.modalName === "import customer" && (
        <Modal
          className={`${cx.ctsModal}`}
          show={props.show}
          onHide={props.handleClose}
