                  ...
                  <Form.Label>
                    ...
                    {["top"].map((placement) => (
                      <OverlayTrigger
                        key={placement}
                        overlay={
                          <Tooltip id={`tooltip-${placement}`}> Qualification</Tooltip>
                        }
                      >
                        <span
                          className={`${cx.tooltips} ms-2`}
                  ...
                  <Form.Label>
                    ...
                    {["top"].map((placement) => (
                      <OverlayTrigger
                        key={placement}
                        overlay={
                          <Tooltip id={`tooltip-${placement}`}> Maximum Discount</Tooltip>
                        }
                      >
                        <span
                          className={`${cx.tooltips} ms-2`}
                  ...
                  <Form.Label>
                    ...
                    {["top"].map((placement) => (
                      <OverlayTrigger
                        key={placement}
                        overlay={
                          <Tooltip id={`tooltip-${placement}`}>Minimum Order (SAR)</Tooltip>
                        }
                      >
                        <span
                          className={`${cx.tooltips} ms-2`}
                  ...
                  <Form.Label>
                    ...
                    {["top"].map((placement) => (
                      <OverlayTrigger
                        key={placement}
                        overlay={
                          <Tooltip id={`tooltip-${placement}`}> Limit To Customer Tags</Tooltip>
                        }
                      >
                        <span
                          className={`${cx.tooltips} ms-2`}
