...
{props.modalName === "Create tag " && (
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>Create Customer Tag </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Row>
              <Col md={12} lg={12}>
...
{props.modalName === "create branch tags" && (
        <Modal
          scrollable
          className={`${cx.ctsModal}`}
          show={props.show}
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>Create Branch Tag </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Row>
              <Col md={12} lg={12}>
...
{props.modalName === "create inventory tags" && (
        <Modal
          scrollable
          className={`${cx.ctsModal}`}
          show={props.show}
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>Create inventory Tag </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Row>
              <Col md={12} lg={12}>
...
{props.modalName === "Order tags" && (
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>Order Tag </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Row>
              <Col md={12} lg={12}>
...
{props.modalName === "suppiler tags" && (
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>Suppiler Tag </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Row>
              <Col md={12} lg={12}>
...
{props.modalName === "user tags" && (
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>User Tag </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Row>
              <Col md={12} lg={12}>
...
{props.modalName === "product tags" && (
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>Product Tag </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Row>
              <Col md={12} lg={12}>
...
{props.modalName === "device tags" && (
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>Device Tag </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Row>
              <Col md={12} lg={12}>
            ...
            <Row>
              <Col md={12} lg={12}>
                <Form.Group className={`${cx.formField}`}>
                  ...
                  <Form.Control type="text" placeholder="sff"/>
                </Form.Group>
              </Col>
              <Col md={12} lg={12}>
                <Form.Group className={`${cx.formField}`}>
                  ...
                  <Form.Control type="text" placeholder="cdc"/>
                </Form.Group>
              </Col>
