...
import { filtertagoptions, SelectallFilter, tagoptions } from "../../constants/dropdownconstants";
...
const Modals = (props: any) => {
  ...
  {/* Edit Role  */}
  {props.modalName ==="remove to users" && (
        <Modal
          className={`${cx.ctsModal}`}
          show={props.show}
          onHide={props.handleClose}
        >
          <Modal.Header closeButton>
            <Modal.Title>Remove To Users</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Row>
              <Col md={12} lg={12}>
                  ...
                  <Form.Label>
                    ...
                    {["top"].map((placement) => (
                      <OverlayTrigger
                        key={placement}
                        overlay={
                          <Tooltip id={`tooltip-${placement}`}> Users</Tooltip>
                        }
                      >
                        <span
                          className={`${cx.tooltips} ms-2`}
  ...
  {props.modalName ==="add to users" && (
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>Add To Users</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Row>
              <Col md={12} lg={12}>
