...
import ManageMoreReasons from "./pages/ManageMoreReasons/ManageMoreReasons";
...
import AuthorizedApplications from "./pages/AuthorizedApplications/AuthorizedApplications";
...
import NewCallCenterOrder from "./pages/NewCallCenterOrder/NewCallCenterOrder";
import InventoryCountDetails from "./pages/InvantoryCountDetails/InvantoryCountDetails";
  ...
  return (
    <Routes>
      <Route path="/" element={<Navigation />}>
        ...
        <Route
          path="inventory/inventory-countsheet/:id"
          element={<Countsheetdetails />}
        />
        ...
        <Route
          ...
          element={<ReportMoreInventoryItemCost />}
        />
        ...
        <Route
          path="/manage/discounts/manage-discount"
        ...
        <Route
          path="/manage/promotions/promotions-detail"
        ...
        <Route
          path="/manage/timed-events/timed-events-details"
        ...
        <Route
          ...
          element={<><ManageMoreSettings /><ManageMoreSettingsGeneral /></>
        }
        />
        <Route
...
<Route
        ...
        <Route path='/marketplace/authorized-applications' element={<AuthorizedApplications />} />
      </Route>
